...
INPUT_FILE_UTF8 = "tests/data/sampledata-utf8.tsv"
...
class TestMTPPFileTSV:
    ...
    def test_tsv_instance_sjis(self):
        target = MTPPFileTSV.read(INPUT_FILE_SJIS, ENCODING_SJIS)
        assert isinstance(target, MTPPData)
    ...
    def test_tsv_write_sjis(self):
        data = MTPPData(RECORDS)
        MTPPFileTSV.write(data, OUTPUT_FILE_SJIS, ENCODING_SJIS)
